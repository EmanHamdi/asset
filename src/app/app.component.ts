...
export class AppComponent implements OnInit, OnDestroy
{
    ...
    rapidPage = "Apples are round, and apples are juicy."; 
splitted = this.rapidPage.split(" ", 3);
...
//     this.text = value;
//     this.nameArr = value.split(" ", 3);
//     for (var a in this.nameArr)
//     {
//         var variable = this.nameArr[a]
//         console.log(variable)
//     }
//     if(this.nameArr.length > 0 && this.nameArr.length < 5){
//         for(var i =0;i<this.nameArr.length;i++);{
//            if(parseInt(this.nameArr[i]) === NaN) return false;
//         }
//        return true;
//    }
//    return false;
